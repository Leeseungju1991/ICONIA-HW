...
| 항목 | dev | prod |
|---|---|---|
| `ICONIA_API_ENDPOINT` | `https://iconia.onrender.com/api/event` | `https://api.iconia.<사내>/api/event` *(교체 필요)* |
...
| `build_profiles/prod.h` | `<사내>` → 운영 도메인, `PROD_API_KEY_PLACEHOLDER` → 실제 운영 API key |
